...
<div class="ui fluid container">
    <div class="ui grid">
        <div class="column">
            ...
            <form class="ui form" method="POST" action="/storage/user/settings">
                {!! csrf_field() !!}
                ...
                <div class="field">
                    ...
                    <a class="ui button teal right floated raw-margin-right-16" href="/storage/user/password">Change Password</a><br>
                </div>
            </form>
        </div>
    </div>
